...
/* harmony import */ var _mobile_menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mobile-menu.js */ "./src/assets/scripts/js/mobile-menu.js");
/* harmony import */ var _mobile_menu_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_mobile_menu_js__WEBPACK_IMPORTED_MODULE_0__);


/***/ }),

/***/ "./src/assets/scripts/js/mobile-menu.js":
/*!**********************************************!*\
  !*** ./src/assets/scripts/js/mobile-menu.js ***!
  \**********************************************/
/***/ (function() {
...
(function ($) {
  ...
  function slide_sub_nav_in() {
    ...
    mobile_menu_items.each(function (index, element) {
      ...
      $(this).attr('data-item', index); // check if li has submenu

      if ($(this).children('.sub-menu').length) {
        let menu = $(this).children('.sub-menu'); // add chevron
...
/* harmony import */ var _assets_scripts_js_main_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/scripts/js/main.js */ "./src/assets/scripts/js/main.js");
// scss
 // js
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksasso"] = self["webpackChunksasso"] || [];
